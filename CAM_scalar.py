...
class CAM(nn.Module):
    def __init__(self, nclasses):
        ...
        self.prior_weight = Parameter(torch.Tensor([1.0]))
    ...
    def forward(self, unary, img, atlas, atlas_label):
        ...
        for i in range(NUM_ITER):
            ...
            message = self._compute(input=softmax_out, atlas_label=atlas_label, gaus_list=_gaus_list, gaus_weight=_gaus_weight, gaus_types=_gaus_types, npixels=npixels)
    ...
    def _compute(self, input, atlas_label, gaus_list, gaus_weight, gaus_types, npixels):
